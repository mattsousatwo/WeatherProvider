...
extension HomeView {
    ...
    func mainWeatherDisplay() -> some View {
        ...
        return VStack {
            WPOTitle(weatherInfo.location.name, color: userDelegate.theme.textColor)
            ...
            WPText(weatherInfo.currentWeather.condition.text, color: userDelegate.theme.textColor)
